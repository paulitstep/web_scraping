...
class BookParser:
    ...
    def name(self):
        ...
        logger.debug(f'Founded book name, `{item_name}`.')
        return item_name
    ...
    def link(self):
        ...
        logger.debug(f'Founded book link, `{item_link}`.')
        return item_link
    ...
    def price(self):
        ...
        logger.debug(f'Founded book price, `{float_price}`.')
        return float_price
    ...
    def rating(self):
        ...
        logger.debug(f'Founded book rating, `{rating_number}`.')
